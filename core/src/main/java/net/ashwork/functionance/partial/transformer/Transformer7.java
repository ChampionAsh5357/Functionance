...
/**
 * Represents a transformer that accepts seven arguments and produces a result.
 ...
 */
@FunctionalInterface
public interface Transformer7<T1, T2, T3, T4, T5, T6, T7, R> extends Transformer8<T1, T2, T3, T4, T5, T6, T7, Object, R> {
     ...
     */
    R apply7(final T1 t1, final T2 t2, final T3 t3, final T4 t4, final T5 t5, final T6 t6, final T7 t7);

    @Override
    default R apply8(final T1 t1, final T2 t2, final T3 t3, final T4 t4, final T5 t5, final T6 t6, final T7 t7, final Object o) {
