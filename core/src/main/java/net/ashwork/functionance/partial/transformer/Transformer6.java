...
/**
 * Represents a transformer that accepts six arguments and produces a result.
 ...
 */
@FunctionalInterface
public interface Transformer6<T1, T2, T3, T4, T5, T6, R> extends Transformer7<T1, T2, T3, T4, T5, T6, Object, R> {
     ...
     */
    R apply6(final T1 t1, final T2 t2, final T3 t3, final T4 t4, final T5 t5, final T6 t6);

    @Override
    default R apply7(final T1 t1, final T2 t2, final T3 t3, final T4 t4, final T5 t5, final T6 t6, final Object o) {
